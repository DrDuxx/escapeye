...
import { GET_GAME, MORTAGE_COLOR } from "../services/sharedQueries";
...
const Mortage = () => {
  ...
  const { mutateAsync: mortageColor, isLoading: mortageColorLoading } =
    useMutation(MORTAGE_COLOR);
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={async () => {
          if (runningGameLoading || mortageColorLoading) return;
          if (!fields.color) {
